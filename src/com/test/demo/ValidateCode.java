...
/*		// randomCode记录随机产生的验证码
		...
		code=drawRandomCode(g,red,green,blue,x,codeY);//字母数字组合
		//code=drawRandomNum(g,red,green,blue);//汉字组合
	}
	...
	private String drawRandomCode(Graphics2D g,int red,int green,int blue,int x,int codeY){
		StringBuffer randomCode = new StringBuffer();
		// 生成随机数
		Random random = new Random();
		// 随机产生codeCount个字符的验证码。
     ...
     */  
    @SuppressWarnings("unused")
	private String drawRandomNum(Graphics2D g,int red,int green,int blue) {  
